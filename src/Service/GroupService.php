...
class GroupService
{
    ...
    public function create($data)
    {
        ...
        if (count($errors) > 0) {
            $exp = new ResourceValidationException('Group validation Exception.');
    ...
    public function delete($id)
    {
        ...
        if (count($group->getMemberships()) > 0) {
            throw new CanNotPerformThisActionException('You cannot delete this group. This group has users.');
        }
